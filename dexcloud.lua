loadstring(game:HttpGet("https://raw.githubusercontent.com/dexcloudhub/dexcloudhub/refs/heads/main/fixlagbydex.lua"))()
...
-- ==========================================
-- LOAD UI LIBRARY (Dex Hub)
-- ==========================================
Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/dexcloudhub/UI/refs/heads/main/ui_BananaHub_final.lua"))()

Window = Library:CreateWindow({
    Title = "dexcloud Hub",
    Desc = "- Blox Fruit",
    Image = "rbxassetid://140625324224912"
})
...
Tabs.Info:AddButton({
    ...
    ["Description"] = "Youtube",
    ["Callback"] = function()
        setclipboard(tostring("https://youtube.com/@chanthibo"))
    end
})
Tabs.Info:AddButton({
    ["Title"] = "dexcloud Hub",
    ["Description"] = "Tiktok",
    ["Callback"] = function()
        setclipboard(tostring("www.tiktok.com/@dexngox"))
    end
})
...
-- ===============================================================
print('✅ Dexcloud Hub - Tất cả tính năng đã được load!')
